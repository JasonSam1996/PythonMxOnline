...
class CourseOrg(models.Model):
    ...
    chick_nums = models.IntegerField(default=0,verbose_name=u'点击信息')
    fav_nums = models.IntegerField(default=0,verbose_name=u'收藏信息')
...
class Teacher(models.Model):
    ...
    work_year = models.IntegerField(default=1,verbose_name=u'工作年龄')
